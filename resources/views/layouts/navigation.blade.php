        ...
        <div class="lg:flex lg:items-center lg:justify-between">
            <div class="flex items-center justify-between">
                <a href="{{route('dashboard')}}">
                    <img class="w-auto h-8 sm:h-9" src="/images/passenopjedier_logo.png" alt="pasopjedier logo">
                </a>
            ...
            <div x-cloak :class="[isOpen ? 'translate-x-0 opacity-100 ' : 'opacity-0 -translate-x-full']" class="absolute inset-x-0 z-30 w-full px-6 py-4 transition-all duration-300 ease-in-out bg-white dark:bg-gray-800 lg:mt-0 lg:p-0 lg:top-0 lg:relative lg:bg-transparent lg:w-auto lg:opacity-100 lg:translate-x-0 lg:flex lg:items-center">
                ...
                <div class="flex items-center mt-4 lg:mt-0">
                    <a type="button" class="flex items-center focus:outline-none" aria-label="toggle profile dropdown" href ="/user/{{ auth()->user()->id }}">
                        @if(auth()->user()->image)
                ...
                <a href="{{route('profile.edit')}}" class="flex items-center focus:outline-none mt-4 lg:mt-0 lg:ms-4">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 dark:text-white text-gray-900" fill="#ffffff"  viewBox="0 0 32 32">
                    ...
                    <h3 class="mx-2 text-gray-700 dark:text-gray-200 lg:hidden">Settings</h3>
                </a>
                <form method="POST" action="{{ route('logout') }}">
                    ...
                    <button type="button" class="flex items-center focus:outline-none mt-4 lg:mt-0 lg:ms-4" aria-label="toggle profile dropdown" href="{{route('logout')}}" onclick="event.preventDefault(); this.closest('form').submit();">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8 dark:text-white text-gray-900" viewBox="0 0 24 24" fill="none">
