<div class="w-full my-4 max-w-sm overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 relative">
    ...
    <div class="px-6 py-4">
                                    ...
                                    @foreach ($users as $user)
                                        @if ($user->id == $aanvraag->user_id)
                                            <div class="bg-gray-200 my-4 p-2 rounded-md">
                                                <p class="text-gray-800 font-semibold text-center text-lg mb-2">{{ $user->name }} wilt oppassen</p>
        ...
        @else
                            ...
                            @else
                                <h3 class="dark:text-white font-semibold mt-4">Review:</h3>
                                <p class="dark:text-white mb-4">{{ $post->review }}</p>
                            @endif
                        @endif
    </div>
</div>